...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '积分球点检记录', to: '/equipment/integrating-sphere-inspections', icon: Lightbulb, resource: 'integrating_sphere_inspection_records', action: 'read' },
      { label: '积分球定标记录', to: '/equipment/integrating-sphere-calibrations', icon: Sun, resource: 'integrating_sphere_calibration_records', action: 'read' },
      { label: '配光曲线点检记录', to: '/equipment/photometric-curve-inspections', icon: Spline, resource: 'photometric_curve_inspection_records', action: 'read' },
      { label: '配光曲线定标记录', to: '/equipment/photometric-curve-calibrations', icon: Waypoints, resource: 'photometric_curve_calibration_records', action: 'read' },
