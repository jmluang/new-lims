...
class IntegratingSphereCalibrationRecord extends Model implements HasMedia
{
    ...
    {
        return $this->hasMany(IntegratingSphereCalibrationEquipment::class, 'calibration_record_id')->orderBy('id');
    }
}
